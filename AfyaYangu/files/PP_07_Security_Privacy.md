...
Security and privacy are foundational to the Patient Portal, protecting sensitive health information while enabling appropriate access for care coordination.
...
```json
{
  "iss": "https://auth.patient-portal.hie.example.com",
  "sub": "patient-123",
...
async function authenticateWithBiometric(): Promise<boolean> {
  ...
  const result = await LocalAuthentication.authenticateAsync({
    promptMessage: 'Authenticate to access Patient Portal',
...
```json
{
  ...
  "agent": [{
    ...
    "who": {
      "identifier": {
        "system": "https://patient-portal.hie.example.com",
        "value": "patient-123"
      },
      "display": "John Doe"
    },
...
**End of Patient Portal Documentation**
